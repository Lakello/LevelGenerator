...
namespace LevelGenerator.Entity
{
    internal class MeshData
    {
        ...
        internal MeshData(int numVertsPerLine, int skipIncrement, bool useFlatShading)
        {
        ...
        internal void AddVertex(Vector3 vertexPosition, Vector2 uv, int vertexIndex)
        {
            if (vertexIndex < 0)
            {
